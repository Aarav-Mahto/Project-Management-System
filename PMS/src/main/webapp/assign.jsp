...
%>
	<form id="container" method="post" action="assignjsp">
		<div id="header">
			...
			<div id="tabs">
				<ul>
					...
					<li name="btn" value="assign"  style="background-color: rgba(102, 0, 102, 0.6);"><a href="assign.jsp">NewAssign <i class="fa-solid fa-grip-lines-vertical"></i></a></li>
		...
		<div id="table_container">
			...
			<div><h1>Projects Assign For Future</h1></div>
			<div id="table_parent">
				<table id="data">
					<thead>
						<tr>
					...
					try {
						...
						PreparedStatement ps = con.prepareStatement("select *from project where pstatus='Newpending'");
