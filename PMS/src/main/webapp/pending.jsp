...
%>
	<form id="container" method="post" action="pendingjsp">
		<div id="header">
			...
			<div id="tabs">
				<ul>
					...
					<li name="btn" value="pending" style="background-color: rgba(102, 0, 102, 0.6);"><a href="pending.jsp">Pending <i class="fa-solid fa-circle-pause"></i></a></li>
				</ul>
			</div>
			<div id="users">
				<ul>
		...
		<div id="table_container">
			...
			<div><h1>Pending Projects</h1></div>
			<div id="table_parent">
				<table id="data">
					<thead>
						<tr>
					...
					try {
						...
						PreparedStatement ps = con.prepareStatement("select *from project where pstatus='Pending'");
