...
%>
	<form id="container" method="post" action="runningjsp">
		<div id="header">
			...
			<div id="tabs">
				<ul>
					...
					<li name="btn" value="running" style="background-color: rgba(102, 0, 102, 0.6);"><a href="running.jsp">Running <i class="fa-solid fa-spinner"></i></a></li>
		...
		<div id="table_container">
			...
			<div><h1>Currently Running Projects</h1></div>
			<div id="table_parent">
				<table id="data">
					<thead>
						<tr>
					...
					try {
						...
						PreparedStatement ps = con.prepareStatement("select *from project where pstatus='Running'");
